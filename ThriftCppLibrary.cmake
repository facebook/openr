find_program(FBTHRIFT_COMPILER thrift1)
find_path(THRIFT_COMPILER_INCLUDE thrift/templates)
set(FBTHRIFT_TEMPLATES_DIR ${THRIFT_COMPILER_INCLUDE}/thrift/templates)
...
function(add_thrift_cpp2_library LIB_NAME THRIFT_FILE)
  ...
  get_filename_component(
    output_dir
    ${CMAKE_CURRENT_BINARY_DIR}/thrift-out/${THRIFT_FILE}
    DIRECTORY
  )
