...
extensions = [
    Extension("openr.thrift.OpenrCtrlCpp.clients",
        ["./openr-thrift/openr/if/gen-py3/openr/thrift/OpenrCtrlCpp/clients.cpp", "openr-thrift/openr/if/gen-py3/OpenrCtrlCpp/clients_wrapper.cpp"],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ),
    Extension("openr.thrift.OpenrCtrl.clients",
        ["./openr-thrift/openr/if/gen-py3/openr/thrift/OpenrCtrl/clients.cpp", "openr-thrift/openr/if/gen-py3/OpenrCtrl/clients_wrapper.cpp"],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ),
    Extension("openr.thrift.Platform.clients",
        ["./openr-thrift/openr/if/gen-py3/openr/thrift/Platform/clients.cpp", "openr-thrift/openr/if/gen-py3/Platform/clients_wrapper.cpp"],
        library_dirs=extension_library_dirs,
        include_dirs=extension_include_dirs,
        libraries=extension_libraries,
    ),
...
for root, dirs, files in os.walk('openr-thrift'):
   for f in files:
       if f.endswith(".pyx"):
           ...
           module = pyx_file.replace('openr-thrift/openr/if/gen-py3/', '').replace('.pyx', '').replace('/', '.')
