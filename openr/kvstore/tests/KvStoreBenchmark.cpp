...
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 100000_1, 100000, 1);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 100000_10, 100000, 10);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 100000_100, 100000, 100);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 100000_1000, 100000, 1000);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 100000_10000, 100000, 10000);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 100000_100000, 100000, 100000);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 1000000_1, 1000000, 1);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 1000000_100, 1000000, 100);
BENCHMARK_NAMED_PARAM(BM_KvStoreMergeKeyValues, 1000000_10000, 1000000, 10000);
BENCHMARK_NAMED_PARAM(
    BM_KvStoreMergeKeyValues, 1000000_100000, 1000000, 100000);
BENCHMARK_NAMED_PARAM(
    BM_KvStoreMergeKeyValues, 1000000_1000000, 1000000, 1000000);
...
BENCHMARK_PARAM(BM_KvStoreDumpAll, 100000);
BENCHMARK_PARAM(BM_KvStoreDumpAll, 1000000);
...
BENCHMARK_PARAM(BM_KvStoreFloodingUpdate, 100000);
BENCHMARK_PARAM(BM_KvStoreFloodingUpdate, 1000000);
